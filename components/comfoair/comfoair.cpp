...
///control to change settings of the climate device.
void ComfoAirComponent::ComfoAirComponent::control(const climate::ClimateCall &call) {
...
void ComfoAirComponent::ComfoAirComponent::dump_config(){
  uint8_t *p;
...
float ComfoAirComponent::get_setup_priority() const{ return setup_priority::DATA; }

void ComfoAirComponent::error_reset(void) {
  uint8_t reset_cmd[4] = {1, 0, 0, 0};
  write_command_(CMD_RESET_AND_SELF_TEST, reset_cmd, sizeof(reset_cmd));
      }

void ComfoAirComponent::filter_reset(void) {
  uint8_t reset_cmd[4] = {0, 0, 0, 1};
  write_command_(CMD_RESET_AND_SELF_TEST, reset_cmd, sizeof(reset_cmd));
      }

void ComfoAirComponent::set_name(const char* value) {name = value;}
void ComfoAirComponent::set_uart_component(uart::UARTComponent *parent) {set_uart_parent(parent);}
...
void ComfoAirComponent::set_type(text_sensor::TextSensor *type) { this->type = type; };
void ComfoAirComponent::set_size(text_sensor::TextSensor *size) { this->size = size; };
void ComfoAirComponent::set_intake_fan_speed(sensor::Sensor *intake_fan_speed) { this->intake_fan_speed = intake_fan_speed; };
void ComfoAirComponent::set_exhaust_fan_speed(sensor::Sensor *exhaust_fan_speed) { this->exhaust_fan_speed = exhaust_fan_speed; };
void ComfoAirComponent::set_intake_fan_speed_rpm(sensor::Sensor *intake_fan_speed_rpm) { this->intake_fan_speed_rpm = intake_fan_speed_rpm; };
void ComfoAirComponent::set_exhaust_fan_speed_rpm(sensor::Sensor *exhaust_fan_speed_rpm) { this->exhaust_fan_speed_rpm = exhaust_fan_speed_rpm; };
void ComfoAirComponent::set_ventilation_level(sensor::Sensor *ventilation_level) { this->ventilation_level = ventilation_level; };
void ComfoAirComponent::set_bypass_valve(sensor::Sensor *bypass_valve) { this->bypass_valve = bypass_valve; };
void ComfoAirComponent::set_bypass_present(binary_sensor::BinarySensor *bypass_present) { this->bypass_present = bypass_present; };
void ComfoAirComponent::set_enthalpy_present(binary_sensor::BinarySensor *enthalpy_present) { this->enthalpy_present = enthalpy_present; };
void ComfoAirComponent::set_ewt_present(binary_sensor::BinarySensor *ewt_present) { this->ewt_present = ewt_present; };
void ComfoAirComponent::set_preheating_present(binary_sensor::BinarySensor *preheating_present) { this->preheating_present = preheating_present; };
void ComfoAirComponent::set_options_present(binary_sensor::BinarySensor *options_present) { this->options_present = options_present; };
void ComfoAirComponent::set_fireplace_present(binary_sensor::BinarySensor *fireplace_present) { this->fireplace_present = fireplace_present; };
void ComfoAirComponent::set_kitchen_hood_present(binary_sensor::BinarySensor *kitchen_hood_present) { this->kitchen_hood_present = kitchen_hood_present; };
void ComfoAirComponent::set_postheating_present(binary_sensor::BinarySensor *postheating_present) { this->postheating_present = postheating_present; };
void ComfoAirComponent::set_postheating_pwm_mode_present(binary_sensor::BinarySensor *postheating_pwm_mode_present) { this->postheating_pwm_mode_present = postheating_pwm_mode_present; };
void ComfoAirComponent::set_bypass_valve_open(binary_sensor::BinarySensor *bypass_valve_open) { this->bypass_valve_open = bypass_valve_open; };
void ComfoAirComponent::set_preheating_state(binary_sensor::BinarySensor *preheating_state) { this->preheating_state = preheating_state; };
void ComfoAirComponent::set_outside_air_temperature(sensor::Sensor *outside_air_temperature) { this->outside_air_temperature = outside_air_temperature; };
void ComfoAirComponent::set_supply_air_temperature(sensor::Sensor *supply_air_temperature) { this->supply_air_temperature = supply_air_temperature; };
void ComfoAirComponent::set_return_air_temperature(sensor::Sensor *return_air_temperature) { this->return_air_temperature = return_air_temperature; };
void ComfoAirComponent::set_exhaust_air_temperature(sensor::Sensor *exhaust_air_temperature) { this->exhaust_air_temperature = exhaust_air_temperature; };
void ComfoAirComponent::set_enthalpy_temperature(sensor::Sensor *enthalpy_temperature) { this->enthalpy_temperature = enthalpy_temperature; };
void ComfoAirComponent::set_ewt_temperature(sensor::Sensor *ewt_temperature) { this->ewt_temperature = ewt_temperature; };
void ComfoAirComponent::set_reheating_temperature(sensor::Sensor *reheating_temperature) { this->reheating_temperature = reheating_temperature; };
void ComfoAirComponent::set_kitchen_hood_temperature(sensor::Sensor *kitchen_hood_temperature) { this->kitchen_hood_temperature = kitchen_hood_temperature; };
void ComfoAirComponent::set_return_air_level(sensor::Sensor *return_air_level) { this->return_air_level = return_air_level; };
void ComfoAirComponent::set_supply_air_level(sensor::Sensor *supply_air_level) { this->supply_air_level = supply_air_level; };
void ComfoAirComponent::set_supply_fan_active(binary_sensor::BinarySensor *supply_fan_active) { this->supply_fan_active = supply_fan_active; };
void ComfoAirComponent::set_filter_status(text_sensor::TextSensor *filter_status) { this->filter_status = filter_status; };
void ComfoAirComponent::set_bypass_factor(sensor::Sensor *bypass_factor) { this->bypass_factor = bypass_factor; };
void ComfoAirComponent::set_bypass_step(sensor::Sensor *bypass_step) { this->bypass_step = bypass_step; };
void ComfoAirComponent::set_bypass_correction(sensor::Sensor *bypass_correction) { this->bypass_correction = bypass_correction; };
void ComfoAirComponent::set_bypass_open_hours(sensor::Sensor *bypass_open_hours) { this->bypass_open_hours = bypass_open_hours; };
void ComfoAirComponent::set_motor_current_bypass(sensor::Sensor *motor_current_bypass) { this->motor_current_bypass = motor_current_bypass; };
void ComfoAirComponent::set_motor_current_preheating(sensor::Sensor *motor_current_preheating) { this->motor_current_preheating = motor_current_preheating; };
void ComfoAirComponent::set_preheating_hours(sensor::Sensor *preheating_hours) { this->preheating_hours = preheating_hours; };
void ComfoAirComponent::set_preheating_valve(text_sensor::TextSensor *preheating_valve) { this->preheating_valve = preheating_valve; };
void ComfoAirComponent::set_level0_hours(sensor::Sensor *level0_hours) { this->level0_hours = level0_hours; };
void ComfoAirComponent::set_level1_hours(sensor::Sensor *level1_hours) { this->level1_hours = level1_hours; };
void ComfoAirComponent::set_level2_hours(sensor::Sensor *level2_hours) { this->level2_hours = level2_hours; };
void ComfoAirComponent::set_level3_hours(sensor::Sensor *level3_hours) { this->level3_hours = level3_hours; };
void ComfoAirComponent::set_frost_protection_active(binary_sensor::BinarySensor *frost_protection_active) { this->frost_protection_active = frost_protection_active; };
void ComfoAirComponent::set_frost_protection_hours(sensor::Sensor *frost_protection_hours) { this->frost_protection_hours = frost_protection_hours; };
void ComfoAirComponent::set_frost_protection_minutes(sensor::Sensor *frost_protection_minutes) { this->frost_protection_minutes = frost_protection_minutes; };
void ComfoAirComponent::set_frost_protection_level(text_sensor::TextSensor *frost_protection_level) { this->frost_protection_level = frost_protection_level; };
void ComfoAirComponent::set_filter_hours(sensor::Sensor *filter_hours) { this->filter_hours = filter_hours; };
void ComfoAirComponent::set_summer_mode(binary_sensor::BinarySensor *summer_mode) { this->summer_mode = summer_mode; };
void ComfoAirComponent::set_p10_active(binary_sensor::BinarySensor *p10_active) { this->p10_active = p10_active; };
void ComfoAirComponent::set_p11_active(binary_sensor::BinarySensor *p11_active) { this->p11_active = p11_active; };
void ComfoAirComponent::set_p12_active(binary_sensor::BinarySensor *p12_active) { this->p12_active = p12_active; };
void ComfoAirComponent::set_p13_active(binary_sensor::BinarySensor *p13_active) { this->p13_active = p13_active; };
void ComfoAirComponent::set_p14_active(binary_sensor::BinarySensor *p14_active) { this->p14_active = p14_active; };
void ComfoAirComponent::set_p15_active(binary_sensor::BinarySensor *p15_active) { this->p15_active = p15_active; };
void ComfoAirComponent::set_p16_active(binary_sensor::BinarySensor *p16_active) { this->p16_active = p16_active; };
void ComfoAirComponent::set_p17_active(binary_sensor::BinarySensor *p17_active) { this->p17_active = p17_active; };
void ComfoAirComponent::set_p18_active(binary_sensor::BinarySensor *p18_active) { this->p18_active = p18_active; };
void ComfoAirComponent::set_p19_active(binary_sensor::BinarySensor *p19_active) { this->p19_active = p19_active; };
void ComfoAirComponent::set_p90_active(binary_sensor::BinarySensor *p90_active) { this->p90_active = p90_active; };
void ComfoAirComponent::set_p91_active(binary_sensor::BinarySensor *p91_active) { this->p91_active = p91_active; };
void ComfoAirComponent::set_p92_active(binary_sensor::BinarySensor *p92_active) { this->p92_active = p92_active; };
void ComfoAirComponent::set_p93_active(binary_sensor::BinarySensor *p93_active) { this->p93_active = p93_active; };
void ComfoAirComponent::set_p94_active(binary_sensor::BinarySensor *p94_active) { this->p94_active = p94_active; };
void ComfoAirComponent::set_p95_active(binary_sensor::BinarySensor *p95_active) { this->p95_active = p95_active; };
void ComfoAirComponent::set_p96_active(binary_sensor::BinarySensor *p96_active) { this->p96_active = p96_active; };
void ComfoAirComponent::set_p97_active(binary_sensor::BinarySensor *p97_active) { this->p97_active = p97_active; };
void ComfoAirComponent::set_bathroom_switch_on_delay_minutes(sensor::Sensor *bathroom_switch_on_delay_minutes) { this->bathroom_switch_on_delay_minutes = bathroom_switch_on_delay_minutes; };
void ComfoAirComponent::set_bathroom_switch_off_delay_minutes(sensor::Sensor *bathroom_switch_off_delay_minutes) { this->bathroom_switch_off_delay_minutes = bathroom_switch_off_delay_minutes; };
void ComfoAirComponent::set_l1_switch_off_delay_minutes(sensor::Sensor *l1_switch_off_delay_minutes) { this->l1_switch_off_delay_minutes = l1_switch_off_delay_minutes; };
void ComfoAirComponent::set_boost_ventilation_minutes(sensor::Sensor *boost_ventilation_minutes) { this->boost_ventilation_minutes = boost_ventilation_minutes; };
void ComfoAirComponent::set_filter_warning_weeks(sensor::Sensor *filter_warning_weeks) { this->filter_warning_weeks = filter_warning_weeks; };
void ComfoAirComponent::set_rf_high_time_short_minutes(sensor::Sensor *rf_high_time_short_minutes) { this->rf_high_time_short_minutes = rf_high_time_short_minutes; };
void ComfoAirComponent::set_rf_high_time_long_minutes(sensor::Sensor *rf_high_time_long_minutes) { this->rf_high_time_long_minutes = rf_high_time_long_minutes; };
void ComfoAirComponent::set_extractor_hood_switch_off_delay_minutes(sensor::Sensor *extractor_hood_switch_off_delay_minutes) { this->extractor_hood_switch_off_delay_minutes = extractor_hood_switch_off_delay_minutes; };
